...
//                if (uri != null &&
//                        ProjectAssetURII.class.isAssignableFrom(uri.getClass())) {
//                    return new ProjectAsset((ProjectAssetURII) uri);
//                }
//
                return null;
            }
    ...
    public static Function<String, ProjectAsset> idToModelObject(final UserI userI) {
